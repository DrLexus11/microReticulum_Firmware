...
- LoRa, TCP and UDP expose independent IFAC namespaces on the secure-node
  branch. The secure-node posture closes WiFi KISS on TCP port 7633, the
  ...
  `tools/ifac/provision.py`; implementation and pending hardware acceptance are
  recorded in `docs/PrivateMesh.md` §8.
